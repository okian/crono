...
func main() {
	...
	webs := []string{
		...
		"http://aparat.com",
		"http://entekhab.ir",
		"http://bbc.com/persian",
		"http://fa.wikipedia.org/wiki",
		"http://fa.wiktionary.org/wiki",
		"http://www.vajehyab.com/?q=%D8%A2%D8%A8",
		"http://hidoctor.ir",
		"http://tebna.ir",
		"http://sid.ir",
		"http://digiato.com",
	...
	c := colly.NewCollector(
		...
		func(x *colly.Collector) {
			...
			x.URLFilters = []*regexp.Regexp{
				...
				ptmaker("isna.ir"),
				ptmaker("ilna.ir"),
				ptmaker("digikala.com"),
				ptmaker("farsnews.com"),
				ptmaker("dictionary.abadis.ir"),
				ptmaker("khabaronline.ir"),
				ptmaker("varzesh3.com"),
				ptmaker("aparat.com"),
				ptmaker("entekhab.ir"),
				ptmaker("bbc.com/persian/"),
				ptmaker("fa.wikipedia.org/wiki/"),
				ptmaker("fa.wiktionary.org/wiki/"),
				ptmaker("vajehyab.com/"),
				ptmaker("hidoctor.ir"),
				ptmaker("tebna.ir"),
				ptmaker("sid.ir"),
				ptmaker("digiato.com"),
				...
				ptmaker("zoomit.ir"),
				ptmaker("chetor.com"),
				ptmaker("ghesticlub.com"),
				ptmaker("radiofarda.com"),
				ptmaker("gamefa.com"),
				ptmaker("beytoote.com"),
				ptmaker("arga-mag.com"),
				ptmaker("parsnaz.com"),
				ptmaker("ninisite.com"),
				ptmaker("tarafdari.com"),
				ptmaker("setare.com"),
